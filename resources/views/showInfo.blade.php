        ...
        <tbody>
            @foreach ($biens as $bien)
                <tr>
                    ...
                    <td>{{ $bien->etat }}</td>
                    <td class="actions">
                        <a style="background:linear-gradient(80deg,rgb(255, 114, 142),rgb(255, 160, 99));"
                            href="/modifierBien/{{ $bien->id }}">Modifier</a>
                        <a style="background:linear-gradient(80deg,rgb(168, 67, 87),rgb(182, 119, 81));"
                            href="/supprimerBien/{{ $bien->id }}">Supprimer</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
        ...
        <tbody>
            @foreach ($employes as $employe)
                <tr>
                    ...
                    <td class="actions">
                        <a style="background:linear-gradient(80deg,rgb(255, 114, 142),rgb(255, 160, 99));"
                            href="/modifierEmploye/{{ $employe->id }}">Modifier</a>
                        <a style="background:linear-gradient(80deg,rgb(168, 67, 87),rgb(182, 119, 81));"
                            href="/supprimerEmploye/{{ $employe->id }}">Supprimer</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
